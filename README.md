...
Может просматривать главную страницу со списком автомобилей.
Может перейти на страницу конкретного автомобиля.
Есть страницы авторизации и регистрации, где пользователь может создать новый аккаунт и авторизоваться.
Прав на создание нового автомобиля, комментария, настройки имеющегося автомобиля у неавторизованного пользователя нет.
...
Создав пользователя и авторизовавшись, появляется возможность создать новый автомобиль, оставить комментарий, отредактировать и удалить собственный автомобиль.
...
По пути ```/admin``` можем перейти на страницу админ-панели.
Авторизоваться необходимо под суперпользователем.
![img_9.png](readme_media/img_9.png)
![img_10.png](readme_media/img_10.png)
![img_11.png](readme_media/img_11.png)
